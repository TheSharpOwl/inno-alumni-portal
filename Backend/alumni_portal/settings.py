...
ALLOWED_HOSTS = ['http://127.0.0.1:3000', 'http://localhost:8000/', 'http://localhost', 'http://localhost:3000', 'http://127.0.0.1:8000', 'http://ziadxkabakibi.fvds.ru', 'http://188.120.255.101', '188.120.255.101']
